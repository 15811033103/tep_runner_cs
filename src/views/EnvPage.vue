...
<!--      <el-table-column prop="id" label="用例id" sortable  />-->
      ...
      <el-table-column prop="value" label="环境参数"  />
    ...
    <div style="margin: 10px 0">
      ...
      <!--对话框 -->
      <el-dialog v-model="dialogVisible" title="新增环境" width="30%" >
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      load(){
        request({url: "http://127.0.0.1:8000/api/envpage/",
          method: 'get',
          params:{
      ...
      searchdata() {
        request({
          url: "http://127.0.0.1:8000/api/env/",
          method: 'get',
          params: {
            "search": this.search,
          }
      ...
      save(){
        ...
        if (!this.form.id){
          ...
          request({
            url: "http://127.0.0.1:8000/api/env/" + this.form.id,
            method: 'post',
            data: this.form
          }).then((res => {
      ...
      handleDelete(id){
        request({
          url: "http://127.0.0.1:8000/api/env/"+id,
          method: 'get',
        }).then((res => {
          if (res.status == 200) {
            this.$messageBox({
